...
public class PythonActivity extends android.app.Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            java.lang.String app_name = info.name;
            java.lang.String package_name = info.packageName;

            // Load the app's __main__ module
            Log.i("Python", "Looking for class: " + package_name + ".__main__");
            java.lang.Class app_module = java.lang.Class.forName(package_name + ".__main__");
            ...
            main.invoke(null, new java.lang.Object [] {
                new java.lang.String [] {app_name}
            });

            if (_listener == null) {
                Log.w("Python", app_name + " didn't configure a listener.");
            } else {
    ...
    void invoke_app_method(
        ...
        if (_listener == null) {
            Log.e("Python", "Can't perform " + method_name +
                ": application didn't configure a listener at creation.");
        } else {
            try {
